{{-- ============================================================
     File: resources/views/sales-pages/index.blade.php
     ============================================================ --}}
@extends('layouts.app')
...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('sales-pages.create') }}" class="btn-primary">⚡ Generate New</a>
</div>
...
@if($pages->isEmpty())
    <div class="card text-center py-16">
        ...
        <a href="{{ route('sales-pages.create') }}" class="btn-primary inline-flex">⚡ Create First Page</a>
    </div>
@else
        ...
        <div class="card hover:shadow-md transition-shadow group">
            ...
            <div class="flex items-center justify-between mb-3">
                <span class="text-xs font-semibold px-2.5 py-1 rounded-full
                    {{ $page->style === 'bold' ? 'bg-gray-900 text-white' : ($page->style === 'minimal' ? 'bg-gray-100 text-gray-700' : 'bg-brand/10 text-brand') }}">
                    {{ ucfirst($page->style) }}
                </span>
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('sales-pages.export', $page) }}" class="btn-secondary text-sm py-2 px-3" title="Export HTML">
                    ↓
                </a>
